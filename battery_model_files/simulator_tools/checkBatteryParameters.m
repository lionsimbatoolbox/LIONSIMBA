...
parameters_list {end+1} = 'Lambda_cu';
...
parameters_list {end+1} = 'Cpcu';
parameters_list {end+1} = 'sig_al';
parameters_list {end+1} = 'sig_cu';
...
parameters_list {end+1} = 'OperatingMode';
parameters_list {end+1} = 'extraData';
parameters_list {end+1} = 'CurrentDensityFunction';
parameters_list {end+1} = 'PowerDensityFunction';
