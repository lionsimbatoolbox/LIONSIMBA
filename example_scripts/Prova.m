...
delta_p2 = param{1}.cs_p_init - mean(out2.cs_surface{1}(end,1:param{1}.Np));
delta_n2 = param{1}.cs_n_init - mean(out2.cs_surface{1}(end,param{1}.Np+1:end));
ce_final2 = out2.ce{1}(end,end);
