...
% one cell and its behavior is plotted after the simulation ends. This is
% the first of two examples. In this case, multiple simulations are run,
% and each of the simulation will start from the final state of the
% previous one. The second example makes use of the internal detection of
% discontinuities in the applied current density in order to carry out the
% car cycling simulation by invoking only once the startSimulation command.
